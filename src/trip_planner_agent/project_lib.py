...
ACTIVITY_CALENDAR = [
    {
        ...
        "location": "The Innovation Atrium, Tech District, Voyagia",
    ...
    },
    {
        ...
        "location": "The Grand Racquet Terrace, Voyagia",
        "description": "Join us for 'Serve & Savor,' the ultimate crossover event for cooking and tennis enthusiasts in Voyagia! Kick off your lunch hour with a friendly round of doubles on our outdoor courts, then unwind with a hands-on cooking workshop led by a local chef, where you'll prepare and enjoy delicious energy-boosting recipes. Whether you come for the sport or the flavors, this energizing luncheon celebrates both passions in a lively outdoor setting. Ideal for anyone who loves to play, cook, or simply savor fresh food and fun!",
        "price": 20,
    ...
    },
    {
        ...
        "location": "Creative Courts Park, Voyagia",
    ...
    },
    {
        ...
        "name": "Voyagia Twilight Writing Escape",
        "start_time": "2025-06-10 19:00",
        "end_time": "2025-06-10 21:00",
        "location": "The Ink Loft, 12 Quill Lane, Voyagia",
        "description": "Join fellow writers for an inspiring evening at The Ink Loft, where words flow as freely as the coffee! This writing-themed event welcomes all—novelists, poets, bloggers, or anyone with a passion for storytelling. Set indoors in Voyagia's coziest lounge, enjoy writing games, group prompts, and opportunities to read your work aloud. Connect, create, and celebrate the art of writing in this creative indoor haven.",
        "price": 15,
    ...
    },
    {
        ...
        "location": "Rhythm Hall, Center Plaza, Voyagia",
    ...
    },
    {
        ...
        "location": "The Digital Atrium, Voyagia",
    ...
    },
    {
        ...
        "name": "Voyagia Art & Music Fusion Fest",
        "start_time": "2025-06-11 15:00",
        "end_time": "2025-06-11 17:30",
        "location": "The Echo Gardens Amphitheater, Voyagia",
        "description": "Immerse yourself in an unforgettable afternoon at the Echo Gardens Amphitheater, where the vibrant worlds of art and music collide! Surrounded by lush gardens under the open sky, enjoy live performances from talented local musicians while exploring an interactive outdoor art gallery featuring works from Voyagia's creative community. This engaging outdoor event is perfect for art and music enthusiasts who love to be inspired and connect with fellow creatives. Don't miss out on the fusion of melodies and colors in a relaxing, friendly atmosphere!",
        "price": 18,
    ...
    },
    {
        ...
        "location": "The Creative Canvas Studio, Artisanal Lane, Voyagia",
    ...
    },
    {
        ...
        "name": "Voyagia Nature & Green Thumb Adventure",
        "start_time": "2025-06-12 08:00",
        "end_time": "2025-06-12 10:00",
        "location": "Echo Ridge Botanical Trails, Voyagia",
    ...
    },
    {
        ...
        "location": "Starlight Amphitheater, Voyagia",
    ...
    },
    {
        ...
        "location": "Whispering Pines Trailhead, Voyagia",
        "description": "Embark on an outdoor writing journey with fellow enthusiasts on the scenic trails of Voyagia! Trail Tales is a unique event that combines hiking through beautiful pine forests and creative writing activities inspired by nature. Whether you love writing poetry, stories, or journal entries, this event is perfect for those who enjoy both writing and hiking. You'll have guided prompts, collaborative exercises, and plenty of fresh air. Suitable for writers of all levels who want to fuel their creativity while exploring the outdoors.",
        "price": 20,
    ...
    },
    {
        ...
        "location": "Virtual Reality Theater, Silicon Plaza, Voyagia",
    ...
    },
    {
        ...
        "location": "The Jiving Parlor, Central Plaza, Voyagia",
        "description": "Start your day with big laughs and even bigger moves at the Laugh & Groove Morning Comedy Dance Bash! Hosted indoors at The Jiving Parlor in the heart of Voyagia, this lively event blends hilarious stand-up performances with upbeat group dance sessions. Whether you love to dance, enjoy comedy, or just want a fun way to kick off your day, you'll find your place here. Perfect for fans of dancing and comedy alike—come ready to laugh, groove, and connect!",
        "price": 15,
    ...
    },
    {
        ...
        "location": "Whispering Pines Trailhead, Voyagia",
        "description": "Step into the great outdoors for Trails & Tales, a unique lunchtime event combining invigorating hiking and creative writing in the beautiful forests of Voyagia. Take in the scenery on a guided hike, pausing at scenic spots to reflect and write with fellow nature-loving writers. Whether you're an avid hiker, passionate about writing, or want to creatively recharge in nature, this outdoor adventure is for you! Please note: This event is outdoors. All writing materials and a light snack provided.",
        "price": 15,
    ...
    },
    {
        ...
        "location": "Sunset Promenade Art Park, Voyagia",
        "description": "Join us for 'Art & Lens: Outdoor Creative Walk', where art lovers and photography enthusiasts unite! Explore the vibrant scenery of Sunset Promenade Art Park in Voyagia, capturing inspiring moments and sketching as you go. Bring your camera, sketchbook, or both, and enjoy a guided creative journey with plenty of opportunities to connect, learn, and create. This engaging event is held entirely outdoors and is perfect for anyone passionate about art and photography.",
        "price": 15,
    ...
    },
    {
        ...
        "location": "Starlit Ridge, Voyagia",
    ...
    },    
    {
        ...
        "location": "Emerald Meadows Park, Voyagia",
    ...
    },
    {
        ...
        "location": "Writers' Waltz Hall, Voyagia",
    ...
    },
    {
        ...
        "location": "Starlight Literary Cafe, Voyagia",
    ...
    },
    {
        ...
        "location": "Grand Courts at Sunfield Park, Voyagia",
...
WEATHER_FORECAST = [
    {
        ...
        "condition": "clear",
        "description": "A bright and sunny day in Voyagia with clear skies and warm temperatures. Perfect weather for outdoor activities!",
    },
    {
        "date": "2025-06-11",
        "city": "Voyagia",
...
def call_activities_api_mocked(
    ...
    Args:
        ...
        city: The city to get activities for. Only "Voyagia" is supported.
    ...
    Returns:
        ...
        for Voyagia between 2025-06-10 and 2025-06-15.
    """
    import datetime

    # If the city is not Voyagia, return an empty list
    if city and city != "Voyagia":
        return []
...
def call_weather_api_mocked(date: str, city: str) -> dict[str, str | int]:
    ...
    # If the city is not Voyagia, return an empty dictionary
    if city != "Voyagia":
        return {}
